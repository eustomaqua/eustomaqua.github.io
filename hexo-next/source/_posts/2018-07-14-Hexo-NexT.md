...
找到文件 `/themes/next/layout/page.swig` ，修改对应参数值即可，参数说明可见 [Hexo 官方文档](https://hexo.io/zh-cn/docs/helpers.html#tagcloud)，颜色可以参考 [网站](https://uigradients.com/#Rastafari) 和 [RGB 颜色参考](https://tool.oschina.net/commons?type=3)
